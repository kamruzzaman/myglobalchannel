    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 col">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-number">Blog1</span>
                    <span class="info-box-text">Plot 1</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-xl-3 col-md-6 col">
            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-number">Blog 2</span>
                    <span class="info-box-text">Plot 2</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-xl-3 col-md-6 col">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-number">Blog 3</span>
                    <span class="info-box-text">Plot 3</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-xl-3 col-md-6 col">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-number">Blog 4</span>
                    <span class="info-box-text">Plot 4</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
