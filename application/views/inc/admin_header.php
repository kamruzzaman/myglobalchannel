...
<html lang="en">
  <head>
    ...
    <title>
        ...
        if(isset($title)){ echo $title; }else{  $title = 'Driver - Dashboard'; echo $title;  }
        ?> 
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=base_url()?>assets/img/user.png" class="user-image rounded-circle" alt="User Image">
            </a>
            <ul class="dropdown-menu scale-up">
              <!-- User image -->
              <li class="user-header">
                <img src="<?=base_url()?>assets/img/default_avatar_male.jpg" class="float-left rounded-circle" alt="User Image">
                <p>
                 <?=$user_data['user_name']?>
             ...
             <li class="user-body" style="padding-top:35px;">
                <div class="row no-gutters">
                  ...
                  <div class="col-12 text-left">
                    <a href="<?= base_url('admin/profile') ?>"><i class="ion ion-settings"></i> My Profile</a>
                  </div>
				          
				  <div role="separator" class="divider col-12"></div>
				  <div class="col-12 text-left">
                    <a href="<?=base_url('welcome/logout')?>"><i class="fa fa-power-off"></i> Logout</a>
                  </div>				
                </div>
                <!-- /.row -->
              </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="user-profile treeview">
           <a href="<?=base_url('admin/')?>">
              ...
              <li><a href="<?=base_url('admin/profile')?>"><i class="fa fa-user mr-5"></i>My Profile </a></li>


        		<li><a href="<?=base_url('welcome/logout')?>"><i class="fa fa-power-off mr-5"></i>Logout</a></li>
          </ul>
        </li>
       
        <li class="<?=($title=='Dashboard' ? 'active' : '')?>"><a href="<?=base_url()?>admin/"><i class="fa fa-dashboard"></i><span>DASHBOARD</span></a></li>
        <li class="<?=($title=='Notice' ? 'active' : '')?>"><a href="<?=base_url()?>admin/notice"><i class="fa fa-bell"></i><span>Notice</span></a></li>
        <li class="<?=($title=='Slider' ? 'active' : '')?>"><a href="<?=base_url()?>admin/slider"><i class="fa fa-file-image-o"></i><span>Banner</span></a></li>
        <li class="<?=($title=='Rotor' ? 'active' : '')?>"><a href="<?=base_url()?>admin/rotor"><i class="fa fa-file-image-o"></i><span>Rotor</span></a></li>
        <li class="<?=($title=='Event' ? 'active' : '')?>"><a href="<?=base_url()?>admin/events"><i class="fa fa-calendar"></i><span>Events</span></a></li>
        <li class="<?=($title=='Category' ? 'active' : '')?>"><a href="<?=base_url()?>admin/category"><i class="fa fa-arrows"></i><span>Category</span></a></li>
        <li class="<?=($title=='Posts' ? 'active' : '')?>"><a href="<?=base_url()?>admin/posts"><i class="fa fa-newspaper-o"></i><span>Posts</span></a></li>
